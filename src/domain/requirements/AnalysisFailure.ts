const messages = {
  ...
  INVALID_OUTPUT: 'The model returned invalid structured requirements. Retry analysis; the previous artifact was preserved.',
...
export class AnalysisFailure extends Error {
  constructor(readonly code: keyof typeof messages) { super(messages[code]); this.name = 'AnalysisFailure'; }
}
